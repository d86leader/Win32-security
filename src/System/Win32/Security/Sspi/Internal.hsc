...
pattern ISC_REQ_INTEGRITY = IscContextReq #{const ISC_REQ_INTEGRITY}
...
pattern ISC_REQ_FORWARD_CREDENTIALS = IscContextReq 0x00400000
pattern ISC_REQ_MANUAL_CRED_VALIDATION = IscContextReq #{const ISC_REQ_MANUAL_CRED_VALIDATION}
pattern ISC_REQ_REPLAY_DETECT = IscContextReq #{const ISC_REQ_REPLAY_DETECT}
...
iscContextReqNames =
  ...
  , (ISC_REQ_INTEGRITY, "ISC_REQ_INTEGRITY")
  ...
  , (ISC_REQ_FORWARD_CREDENTIALS, "ISC_REQ_FORWARD_CREDENTIALS")
...
pattern SEC_I_RENEGOTIATE = #{const SEC_I_RENEGOTIATE}
...
pattern ASC_REQ_INTEGRITY = AscContextReq #{const ASC_REQ_INTEGRITY}
pattern ASC_REQ_CONFIDENTIALITY = AscContextReq #{const ASC_REQ_CONFIDENTIALITY}
...
pattern ASC_REQ_USE_SESSION_KEY = AscContextReq #{const ASC_REQ_USE_SESSION_KEY}
...
ascContextReqNames =
  ...
  , (ASC_REQ_INTEGRITY, "ASC_REQ_INTEGRITY")
  ...
  , (ASC_REQ_USE_SESSION_KEY, "ASC_REQ_USE_SESSION_KEY")
  ]
